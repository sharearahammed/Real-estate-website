...
const ResidentialCards = () => {
  ...
  return (
    ...
    data-aso-duration='1000' className="text-center text-xl lg:text-4xl font-bold mb-4">All Properties</h1>
        <p data-aos='fade-down'
    data-aso-duration='1000' data-aos-delay="1000" className="text-center text-[12px] text-slate-600 lg:text-[18px]">Explore our carefully curated selection of properties, from dynamic urban residences to tranquil suburban <br/> retreats. With options to suit every taste, discover your ideal home where luxury meets comfort, promising a <br/>lifestyle of fulfillment and serenity. Your dream sanctuary awaits, ready to redefine the concept of home.</p>
        </div>

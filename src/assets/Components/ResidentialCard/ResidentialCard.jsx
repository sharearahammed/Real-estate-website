...
const ResidentialCard = ({ card }) => {
  ...
  return (
    <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-full transition-all duration-700 lg:hover:scale-105 lg:hover:border-blue-500 hover:shadow-2xl border">
      <div
        data-aos="zoom-in"
      ...
      >
        <img className="h-[300px] w-[500px]" src={image} alt={segment_name} />
      </div>
      <div className="p-6">
